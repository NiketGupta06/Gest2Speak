# 🎯 Gest2Speak: CNN+LSTM Gesture-to-Speech Conversion System
...
- 📷 **Camera Input** integration through OpenCV and MediaPipe.  
- 🔊 **Instant Speech Output** using text-to-speech synthesis.  
